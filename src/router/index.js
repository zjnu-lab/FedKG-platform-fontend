...
const router = createRouter({
  ...
  routes: [
    ...
    // 知识图谱
    {
      ...
      component: () => import("@/views/knowledgeMap/add.vue")
    },
    {
      path: '/knowledgeMapSearch',
      name: 'knowledgeMapSearch',
      component: () => import("@/views/knowledgeMap/search.vue")
    },
    {
      path: '/knowledgeMapShow',
      name: 'knowledgeMapShow',
      component: () => import("@/views/knowledgeMap/show.vue")
    },
    ...
    // 实体添加
    {
      ...
      component: () => import("@/views/reality/adminList.vue")
    },
    {
      path: '/realityUserList',
      name: 'realityUserList',
      component: () => import("@/views/reality/userList.vue")
    },
    {
      path: '/realityPassList',
      name: 'realityPassList',
      component: () => import("@/views/reality/passList.vue")
    },
    {
      path: '/realityWaitSyncList',
      name: 'realityWaitSyncList',
      component: () => import("@/views/reality/waitSyncList.vue")
    },
    {
      path: '/realityModify',
      name: 'realityModify',
      component: () => import("@/views/reality/modify.vue")
    },
  ]
})
